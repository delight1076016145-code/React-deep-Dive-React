...
import TodoActonCreator from "../redux/TodoActonCreator";
...
const EditTodoContainer = () => {
  ...
  const editTodo = (args: { id: number; todo: string; desc: string; done: boolean }) => dispatch(TodoActonCreator.updateTodo(args));
  return <EditTodo todoList={todoList} updateTodo={editTodo} />;
};
